...
function LoadingComponent() {
  return (
    <div className="flex items-center justify-center h-screen min-h-[600px] w-full bg-gray-900 text-white">
...
function SafeComponent({ children }) {
  ...
  return (
    <div className="w-full h-full min-h-[1000px] min-w-[1000px]">
      {children}
    </div>
  );
}
